...
CEntityProperty CCamera_properties[] = {
 ...
 CEntityProperty(CEntityProperty::EPT_ENTITYPTR, NULL, (0x000000dc<<8)+84, offsetof(CCamera, m_penActionTarget), "Action Target", 'C', C_lBLUE  | 0xFF, 0),
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x000000dc<<8)+85, offsetof(CCamera, m_bActive), "Active Camera", 0, 0x7F0000FFUL, 0),
};
...
Main),DEBUGSTRING("CCamera::Main")},
 {0x00dc0000, -1, CEntity::pEventHandler(&CCamera::H0x00dc0000_Main_01), DEBUGSTRING("CCamera::H0x00dc0000_Main_01")},
 {0x00dc0001, -1, CEntity::pEventHandler(&CCamera::H0x00dc0001_Main_02), DEBUGSTRING("CCamera::H0x00dc0001_Main_02")},
 {0x00dc0002, -1, CEntity::pEventHandler(&CCamera::H0x00dc0002_Main_03), DEBUGSTRING("CCamera::H0x00dc0002_Main_03")},
 {0x00dc0003, -1, CEntity::pEventHandler(&CCamera::H0x00dc0003_Main_04), DEBUGSTRING("CCamera::H0x00dc0003_Main_04")},
 {0x00dc0004, -1, CEntity::pEventHandler(&CCamera::H0x00dc0004_Main_05), DEBUGSTRING("CCamera::H0x00dc0004_Main_05")},
 {0x00dc0005, -1, CEntity::pEventHandler(&CCamera::H0x00dc0005_Main_06), DEBUGSTRING("CCamera::H0x00dc0005_Main_06")},
 {0x00dc0006, -1, CEntity::pEventHandler(&CCamera::H0x00dc0006_Main_07), DEBUGSTRING("CCamera::H0x00dc0006_Main_07")},
 {0x00dc0007, -1, CEntity::pEventHandler(&CCamera::
...
PlayStaticCamera),DEBUGSTRING("CCamera::PlayStaticCamera")},
 {0x00dc0008, -1, CEntity::pEventHandler(&CCamera::H0x00dc0008_PlayStaticCamera_01), DEBUGSTRING("CCamera::H0x00dc0008_PlayStaticCamera_01")},
 {0x00dc0009, -1, CEntity::pEventHandler(&CCamera::H0x00dc0009_PlayStaticCamera_02), DEBUGSTRING("CCamera::H0x00dc0009_PlayStaticCamera_02")},
 {0x00dc000a, -1, CEntity::pEventHandler(&CCamera::
...
PlayAutoRotatingCamera),DEBUGSTRING("CCamera::PlayAutoRotatingCamera")},
 {0x00dc000b, -1, CEntity::pEventHandler(&CCamera::H0x00dc000b_PlayAutoRotatingCamera_01), DEBUGSTRING("CCamera::H0x00dc000b_PlayAutoRotatingCamera_01")},
 {0x00dc000c, -1, CEntity::pEventHandler(&CCamera::H0x00dc000c_PlayAutoRotatingCamera_02), DEBUGSTRING("CCamera::H0x00dc000c_PlayAutoRotatingCamera_02")},
 {0x00dc000d, -1, CEntity::pEventHandler(&CCamera::
...
PlayMovingCamera),DEBUGSTRING("CCamera::PlayMovingCamera")},
 {0x00dc000e, -1, CEntity::pEventHandler(&CCamera::H0x00dc000e_PlayMovingCamera_01), DEBUGSTRING("CCamera::H0x00dc000e_PlayMovingCamera_01")},
 {0x00dc000f, -1, CEntity::pEventHandler(&CCamera::H0x00dc000f_PlayMovingCamera_02), DEBUGSTRING("CCamera::H0x00dc000f_PlayMovingCamera_02")},
