...
CDLLEntityEvent *CEnvironmentMarker_events[] = {NULL};
#define CEnvironmentMarker_eventsct 0
...
#define MODEL_MARKER ((0x00000385<<8)+1)
 CEntityComponent(ECT_MODEL, MODEL_MARKER, 2, "EFNM" "Data\\Models\\Editor\\EnvironmentMarker.mdl"),
#define TEXTURE_MARKER ((0x00000385<<8)+2)
 CEntityComponent(ECT_TEXTURE, TEXTURE_MARKER, 2, "EFNM" "Data\\Models\\Editor\\EnvironmentMarker.tex"),
};
