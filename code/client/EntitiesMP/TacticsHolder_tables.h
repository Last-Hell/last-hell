...
CDLLEntityEvent *CTacticsHolder_events[] = {NULL};
#define CTacticsHolder_eventsct 0
...
#define MODEL_MANAGER ((0x000000eb<<8)+1)
 CEntityComponent(ECT_MODEL, MODEL_MANAGER, 2, "EFNM" "Data\\ModelsMP\\Editor\\TacticsHolder.mdl"),
#define TEXTURE_MANAGER ((0x000000eb<<8)+2)
 CEntityComponent(ECT_TEXTURE, TEXTURE_MANAGER, 2, "EFNM" "Data\\ModelsMP\\Editor\\TacticsHolder.tex"),
};
