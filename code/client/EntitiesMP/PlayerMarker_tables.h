...
CEntityEvent *ETriggerPlayerMarker_New(void) { return new ETriggerPlayerMarker; };
CDLLEntityEvent DLLEvent_ETriggerPlayerMarker = {
	0x01940000, &ETriggerPlayerMarker_New
};
CDLLEntityEvent *CPlayerMarker_events[] = {
	&DLLEvent_ETriggerPlayerMarker,
};
#define CPlayerMarker_eventsct ARRAYCOUNT(CPlayerMarker_events)
...
CEntityProperty CPlayerMarker_properties[] = {
 ...
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x00000194<<8)+30, offsetof(CPlayerMarker, m_bStartInComputerOnce), "Start in computer only once", 0, 0x7F0000FFUL, 0),
...
#define MODEL_MARKER ((0x00000194<<8)+1)
 CEntityComponent(ECT_MODEL, MODEL_MARKER, 2, "EFNM" "Data\\Models\\Editor\\PlayerStart.mdl"),
#define TEXTURE_MARKER ((0x00000194<<8)+2)
 CEntityComponent(ECT_TEXTURE, TEXTURE_MARKER, 2, "EFNM" "Data\\Models\\Editor\\PlayerStart.tex"),
};
