...
CDLLEntityEvent *CRollingStone_events[] = {NULL};
#define CRollingStone_eventsct 0
...
#define MODEL_ROLLINGSTONE ((0x0000025c<<8)+1)
 CEntityComponent(ECT_MODEL, MODEL_ROLLINGSTONE, 0, "EFNM" "Data\\Models\\Ages\\Egypt\\Traps\\RollingStone\\RollingStone.mdl"),
#define MODEL_STONESPHERE ((0x0000025c<<8)+2)
 CEntityComponent(ECT_MODEL, MODEL_STONESPHERE, 0, "EFNM" "Data\\Models\\Ages\\Egypt\\Traps\\RollingStone\\Stone.mdl"),
#define TEXTURE_ROLLINGSTONE ((0x0000025c<<8)+3)
 CEntityComponent(ECT_TEXTURE, TEXTURE_ROLLINGSTONE, 0, "EFNM" "Data\\Models\\Ages\\Egypt\\Traps\\RollingStone\\Stone.tex"),
#define TEXTURE_DETAIL ((0x0000025c<<8)+5)
 CEntityComponent(ECT_TEXTURE, TEXTURE_DETAIL, 0, "EFNM" "Data\\Models\\Ages\\Egypt\\Traps\\RollingStone\\Detail.tex"),
...
#define SOUND_BOUNCE ((0x0000025c<<8)+20)
 CEntityComponent(ECT_SOUND, SOUND_BOUNCE, 0, "EFNM" "data\\sounds\\Default.wav"),
#define SOUND_ROLL ((0x0000025c<<8)+21)
 CEntityComponent(ECT_SOUND, SOUND_ROLL, 0, "EFNM" "data\\sounds\\Default.wav"),
};
...
#line 240 "C:/Users/djcyb/Desktop/BAckups/Reco_Csrc/EntitiesMP/RollingStone.es"
