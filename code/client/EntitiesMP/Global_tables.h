...
CEntityEvent *EDoorControll_New(void) { return new EDoorControll; };
CDLLEntityEvent DLLEvent_EDoorControll = {
	0x0000000f, &EDoorControll_New
};
...
EP_ENUMBEG(EventEType)
	...
	EP_ENUMVALUE(EET_DOORCONTROLL, "Door open or close event"),
