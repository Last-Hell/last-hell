...
CDLLEntityEvent *CHudPicHolder_events[] = {NULL};
#define CHudPicHolder_eventsct 0
...
Main),DEBUGSTRING("CHudPicHolder::Main")},
 {0x00f10000, -1, CEntity::pEventHandler(&CHudPicHolder::H0x00f10000_Main_01), DEBUGSTRING("CHudPicHolder::H0x00f10000_Main_01")},
 {0x00f10001, -1, CEntity::pEventHandler(&CHudPicHolder::H0x00f10001_Main_02), DEBUGSTRING("CHudPicHolder::H0x00f10001_Main_02")},
 {0x00f10002, -1, CEntity::pEventHandler(&CHudPicHolder::H0x00f10002_Main_03), DEBUGSTRING("CHudPicHolder::H0x00f10002_Main_03")},
 {0x00f10003, -1, CEntity::pEventHandler(&CHudPicHolder::H0x00f10003_Main_04), DEBUGSTRING("CHudPicHolder::H0x00f10003_Main_04")},
 {0x00f10004, -1, CEntity::pEventHandler(&CHudPicHolder::
...
WaitAndFadeOut),DEBUGSTRING("CHudPicHolder::WaitAndFadeOut")},
 {0x00f10005, -1, CEntity::pEventHandler(&CHudPicHolder::H0x00f10005_WaitAndFadeOut_01), DEBUGSTRING("CHudPicHolder::H0x00f10005_WaitAndFadeOut_01")},
 {0x00f10006, -1, CEntity::pEventHandler(&CHudPicHolder::H0x00f10006_WaitAndFadeOut_02), DEBUGSTRING("CHudPicHolder::H0x00f10006_WaitAndFadeOut_02")},
 {0x00f10007, -1, CEntity::pEventHandler(&CHudPicHolder::
...
ApplyFadeOut),DEBUGSTRING("CHudPicHolder::ApplyFadeOut")},
 {0x00f10008, -1, CEntity::pEventHandler(&CHudPicHolder::H0x00f10008_ApplyFadeOut_01), DEBUGSTRING("CHudPicHolder::H0x00f10008_ApplyFadeOut_01")},
 {0x00f10009, -1, CEntity::pEventHandler(&CHudPicHolder::H0x00f10009_ApplyFadeOut_02), DEBUGSTRING("CHudPicHolder::H0x00f10009_ApplyFadeOut_02")},
 {0x00f1000a, -1, CEntity::pEventHandler(&CHudPicHolder::H0x00f1000a_ApplyFadeOut_03), DEBUGSTRING("CHudPicHolder::H0x00f1000a_ApplyFadeOut_03")},
};
