...
CEntityEvent *ECopierTrigger_New(void) { return new ECopierTrigger; };
CDLLEntityEvent DLLEvent_ECopierTrigger = {
	0x00e10000, &ECopierTrigger_New
};
CDLLEntityEvent *CCopier_events[] = {
	&DLLEvent_ECopierTrigger,
};
#define CCopier_eventsct ARRAYCOUNT(CCopier_events)
...
#define MODEL_TELEPORT ((0x000000e1<<8)+1)
 CEntityComponent(ECT_MODEL, MODEL_TELEPORT, 2, "EFNM" "Data\\Models\\Editor\\Copier.mdl"),
#define TEXTURE_TELEPORT ((0x000000e1<<8)+2)
 CEntityComponent(ECT_TEXTURE, TEXTURE_TELEPORT, 2, "EFNM" "Data\\Models\\Editor\\Copier.tex"),
...
#line 128 "C:/Users/djcyb/Desktop/BAckups/Reco_Csrc/EntitiesMP/Copier.es"
Main),DEBUGSTRING("CCopier::Main")},
 {0x00e10001, -1, CEntity::pEventHandler(&CCopier::H0x00e10001_Main_01), DEBUGSTRING("CCopier::H0x00e10001_Main_01")},
 {0x00e10002, -1, CEntity::pEventHandler(&CCopier::H0x00e10002_Main_02), DEBUGSTRING("CCopier::H0x00e10002_Main_02")},
 {0x00e10003, -1, CEntity::pEventHandler(&CCopier::H0x00e10003_Main_03), DEBUGSTRING("CCopier::H0x00e10003_Main_03")},
 {0x00e10004, -1, CEntity::pEventHandler(&CCopier::H0x00e10004_Main_04), DEBUGSTRING("CCopier::H0x00e10004_Main_04")},
 {0x00e10005, -1, CEntity::pEventHandler(&CCopier::H0x00e10005_Main_05), DEBUGSTRING("CCopier::H0x00e10005_Main_05")},
 {0x00e10006, -1, CEntity::pEventHandler(&CCopier::H0x00e10006_Main_06), DEBUGSTRING("CCopier::H0x00e10006_Main_06")},
};
