...
CEntityEvent *ETriggerLightning_New(void) { return new ETriggerLightning; };
CDLLEntityEvent DLLEvent_ETriggerLightning = {
	0x025f0000, &ETriggerLightning_New
};
CDLLEntityEvent *CLightning_events[] = {
	&DLLEvent_ETriggerLightning,
};
#define CLightning_eventsct ARRAYCOUNT(CLightning_events)
...
#define SOUND_THUNDER1 ((0x0000025f<<8)+3)
 CEntityComponent(ECT_SOUND, SOUND_THUNDER1, 0, "EFNM" "data\\sounds\\Default.wav"),
#define SOUND_THUNDER2 ((0x0000025f<<8)+4)
 CEntityComponent(ECT_SOUND, SOUND_THUNDER2, 0, "EFNM" "data\\sounds\\Default.wav"),
#define SOUND_THUNDER3 ((0x0000025f<<8)+5)
 CEntityComponent(ECT_SOUND, SOUND_THUNDER3, 0, "EFNM" "data\\sounds\\Default.wav"),
};
...
#line 98 "C:/Users/djcyb/Desktop/BAckups/Reco_Csrc/EntitiesMP/Lightning.es"
Main),DEBUGSTRING("CLightning::Main")},
 {0x025f0001, -1, CEntity::pEventHandler(&CLightning::H0x025f0001_Main_01), DEBUGSTRING("CLightning::H0x025f0001_Main_01")},
 {0x025f0002, -1, CEntity::pEventHandler(&CLightning::H0x025f0002_Main_02), DEBUGSTRING("CLightning::H0x025f0002_Main_02")},
 {0x025f0003, -1, CEntity::pEventHandler(&CLightning::H0x025f0003_Main_03), DEBUGSTRING("CLightning::H0x025f0003_Main_03")},
 {0x025f0004, -1, CEntity::pEventHandler(&CLightning::H0x025f0004_Main_04), DEBUGSTRING("CLightning::H0x025f0004_Main_04")},
 {0x025f0005, -1, CEntity::pEventHandler(&CLightning::H0x025f0005_Main_05), DEBUGSTRING("CLightning::H0x025f0005_Main_05")},
 {0x025f0006, -1, CEntity::pEventHandler(&CLightning::H0x025f0006_Main_06), DEBUGSTRING("CLightning::H0x025f0006_Main_06")},
 {0x025f0007, -1, CEntity::pEventHandler(&CLightning::
#line 201 "C:/Users/djcyb/Desktop/BAckups/Reco_Csrc/EntitiesMP/Lightning.es"
LightningStike),DEBUGSTRING("CLightning::LightningStike")},
 {0x025f0008, -1, CEntity::pEventHandler(&CLightning::H0x025f0008_LightningStike_01), DEBUGSTRING("CLightning::H0x025f0008_LightningStike_01")},
 {0x025f0009, -1, CEntity::pEventHandler(&CLightning::H0x025f0009_LightningStike_02), DEBUGSTRING("CLightning::H0x025f0009_LightningStike_02")},
 {0x025f000a, -1, CEntity::pEventHandler(&CLightning::H0x025f000a_LightningStike_03), DEBUGSTRING("CLightning::H0x025f000a_LightningStike_03")},
 {0x025f000b, -1, CEntity::pEventHandler(&CLightning::H0x025f000b_LightningStike_04), DEBUGSTRING("CLightning::H0x025f000b_LightningStike_04")},
 {0x025f000c, -1, CEntity::pEventHandler(&CLightning::H0x025f000c_LightningStike_05), DEBUGSTRING("CLightning::H0x025f000c_LightningStike_05")},
 {0x025f000d, -1, CEntity::pEventHandler(&CLightning::H0x025f000d_LightningStike_06), DEBUGSTRING("CLightning::H0x025f000d_LightningStike_06")},
 {0x025f000e, -1, CEntity::pEventHandler(&CLightning::H0x025f000e_LightningStike_07), DEBUGSTRING("CLightning::H0x025f000e_LightningStike_07")},
 {0x025f000f, -1, CEntity::pEventHandler(&CLightning::H0x025f000f_LightningStike_08), DEBUGSTRING("CLightning::H0x025f000f_LightningStike_08")},
 {0x025f0010, -1, CEntity::pEventHandler(&CLightning::H0x025f0010_LightningStike_09), DEBUGSTRING("CLightning::H0x025f0010_LightningStike_09")},
};
