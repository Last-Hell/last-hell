...
EP_ENUMBEG(DebugTargetType)
	EP_ENUMVALUE(DTT_MANUAL, "Manual target"),
	EP_ENUMVALUE(DTT_PLAYER, "Player"),
	EP_ENUMVALUE(DTT_PLAYERWEAPONS, "Player weapons"),
	EP_ENUMVALUE(DTT_PLAYERANIMATOR, "Player animator"),
EP_ENUMEND(DebugTargetType);

CDLLEntityEvent *CEntityStateDisplay_events[] = {NULL};
#define CEntityStateDisplay_eventsct 0
...
CEntityProperty CEntityStateDisplay_properties[] = {
 ...
 CEntityProperty(CEntityProperty::EPT_ENTITYPTR, NULL, (0x000000e9<<8)+2, offsetof(CEntityStateDisplay, m_penManualTarget), "Manual Target", 'T', C_dGREEN  | 0xFF, 0),
 CEntityProperty(CEntityProperty::EPT_ENUM, &DebugTargetType_enum, (0x000000e9<<8)+3, offsetof(CEntityStateDisplay, m_eTargetType), "Target type", 0, 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x000000e9<<8)+4, offsetof(CEntityStateDisplay, m_bSkaStateDebug), "Show SKA states", 0, 0x7F0000FFUL, 0),
};
...
#define MODEL_MARKER ((0x000000e9<<8)+1)
 CEntityComponent(ECT_MODEL, MODEL_MARKER, 2, "EFNM" "Data\\Models\\Editor\\Debug_EntityStack.mdl"),
#define TEXTURE_MARKER ((0x000000e9<<8)+2)
 CEntityComponent(ECT_TEXTURE, TEXTURE_MARKER, 2, "EFNM" "Data\\Models\\Editor\\Debug_EntityStack.tex"),
};
...
#line 82 "C:/Users/djcyb/Desktop/BAckups/Reco_Csrc/EntitiesMP/DebugEntityStatesDisplay.es"
Main),DEBUGSTRING("CEntityStateDisplay::Main")},
 ...
 {0x00e90004, -1, CEntity::pEventHandler(&CEntityStateDisplay::H0x00e90004_Main_05), DEBUGSTRING("CEntityStateDisplay::H0x00e90004_Main_05")},
 {0x00e90005, -1, CEntity::pEventHandler(&CEntityStateDisplay::H0x00e90005_Main_06), DEBUGSTRING("CEntityStateDisplay::H0x00e90005_Main_06")},
};
