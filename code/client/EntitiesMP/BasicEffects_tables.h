...
CEntityEvent *ESpawnEffect_New(void) { return new ESpawnEffect; };
CDLLEntityEvent DLLEvent_ESpawnEffect = {
	0x02590000, &ESpawnEffect_New
};
CDLLEntityEvent *CBasicEffect_events[] = {
	&DLLEvent_ESpawnEffect,
};
#define CBasicEffect_eventsct ARRAYCOUNT(CBasicEffect_events)
#define ENTITYCLASS CBasicEffect

CEntityProperty CBasicEffect_properties[] = {
 CEntityProperty(CEntityProperty::EPT_ENUM, &BasicEffectType_enum, (0x00000259<<8)+1, offsetof(CBasicEffect, m_betType), "", 0, 0, EPROPF_NETSEND ),
 ...
 CEntityProperty(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000259<<8)+6, offsetof(CBasicEffect, m_vNormal), "", 0, 0, EPROPF_NETSEND ),
 CEntityProperty(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000259<<8)+7, offsetof(CBasicEffect, m_vStretch), "", 0, 0, EPROPF_NETSEND ),
 CEntityProperty(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000259<<8)+8, offsetof(CBasicEffect, m_vDirection), "", 0, 0, EPROPF_NETSEND ),
...
#define MDL_ROCKET_EXPLOSION ((0x00000259<<8)+1)
 CEntityComponent(ECT_MODEL, MDL_ROCKET_EXPLOSION, 0, "EFNM" "Data\\Models\\Effects\\ExplosionRocket\\ExplosionRocket.mdl"),
#define MDL_ROCKET3D_EXPLOSION ((0x00000259<<8)+2)
 CEntityComponent(ECT_MODEL, MDL_ROCKET3D_EXPLOSION, 0, "EFNM" "Data\\Models\\Effects\\ExplosionRocket\\ExplosionRocket3D.mdl"),
#define TXT_ROCKET_EXPLOSION ((0x00000259<<8)+3)
 CEntityComponent(ECT_TEXTURE, TXT_ROCKET_EXPLOSION, 0, "EFNM" "Data\\Models\\Effects\\Explosionrocket\\Texture.tex"),
#define MDL_GRENADE_EXPLOSION ((0x00000259<<8)+4)
 CEntityComponent(ECT_MODEL, MDL_GRENADE_EXPLOSION, 0, "EFNM" "Data\\Models\\Effects\\ExplosionGrenade\\ExplosionGrenade.mdl"),
#define MDL_GRENADE3D_EXPLOSION ((0x00000259<<8)+5)
 CEntityComponent(ECT_MODEL, MDL_GRENADE3D_EXPLOSION, 0, "EFNM" "Data\\Models\\Effects\\ExplosionGrenade\\ExplosionGrenade3D.mdl"),
#define TXT_GRENADE_EXPLOSION ((0x00000259<<8)+6)
 CEntityComponent(ECT_TEXTURE, TXT_GRENADE_EXPLOSION, 0, "EFNM" "Data\\Models\\Effects\\ExplosionGrenade\\Texture.tex"),
#define MDL_PARTICLES_EXPLOSION ((0x00000259<<8)+7)
 CEntityComponent(ECT_MODEL, MDL_PARTICLES_EXPLOSION, 0, "EFNM" "Data\\Models\\Effects\\ExplosionParticles\\Particles.mdl"),
#define MDL_PARTICLES3D_EXPLOSION ((0x00000259<<8)+8)
 CEntityComponent(ECT_MODEL, MDL_PARTICLES3D_EXPLOSION, 0, "EFNM" "Data\\Models\\Effects\\ExplosionParticles\\Particles3D.mdl"),
#define TXT_PARTICLES_EXPLOSION ((0x00000259<<8)+9)
 CEntityComponent(ECT_TEXTURE, TXT_PARTICLES_EXPLOSION, 0, "EFNM" "Data\\Models\\Effects\\ExplosionParticles\\Texture.tex"),
#define SOUND_EXPLOSION ((0x00000259<<8)+10)
 CEntityComponent(ECT_SOUND, SOUND_EXPLOSION, 0, "EFNM" "data\\sounds\\Default.wav"),
#define MDL_CANNON_EXPLOSION ((0x00000259<<8)+11)
 CEntityComponent(ECT_MODEL, MDL_CANNON_EXPLOSION, 0, "EFNM" "Data\\Models\\Effects\\ExplosionGrenade\\ExplosionGrenade.mdl"),
#define MDL_CANNON3D_EXPLOSION ((0x00000259<<8)+12)
 CEntityComponent(ECT_MODEL, MDL_CANNON3D_EXPLOSION, 0, "EFNM" "Data\\Models\\Effects\\ExplosionGrenade\\ExplosionGrenade3D.mdl"),
#define TXT_CANNON_EXPLOSION ((0x00000259<<8)+13)
 CEntityComponent(ECT_TEXTURE, TXT_CANNON_EXPLOSION, 0, "EFNM" "Data\\Models\\Effects\\ExplosionGrenade\\Texture.tex"),
#define MODEL_BULLET_HIT ((0x00000259<<8)+15)
 CEntityComponent(ECT_MODEL, MODEL_BULLET_HIT, 0, "EFNM" "Data\\Models\\Effects\\BulletParticles\\BulletParticles.mdl"),
#define TEXTURE_BULLET_HIT ((0x00000259<<8)+16)
 CEntityComponent(ECT_TEXTURE, TEXTURE_BULLET_HIT, 0, "EFNM" "Data\\Models\\Effects\\BulletParticles\\BulletParticles.tex"),
#define MODEL_BULLET_STAIN ((0x00000259<<8)+18)
 CEntityComponent(ECT_MODEL, MODEL_BULLET_STAIN, 0, "EFNM" "Data\\Models\\Effects\\BulletOnTheWall\\Bullet.mdl"),
#define TEXTURE_BULLET_STAIN ((0x00000259<<8)+19)
 CEntityComponent(ECT_TEXTURE, TEXTURE_BULLET_STAIN, 0, "EFNM" "Data\\Models\\Effects\\BulletOnTheWall\\Bullet.tex"),
#define TEXTURE_BULLET_TRAIL ((0x00000259<<8)+70)
 CEntityComponent(ECT_TEXTURE, TEXTURE_BULLET_TRAIL, 0, "EFNM" "Data\\Models\\Effects\\BulletTrail\\BulletTrail.tex"),
#define MODEL_BULLET_TRAIL ((0x00000259<<8)+71)
 CEntityComponent(ECT_MODEL, MODEL_BULLET_TRAIL, 0, "EFNM" "Data\\Models\\Effects\\BulletTrail\\BulletTrail.mdl"),
#define SOUND_BULLET_STONE ((0x00000259<<8)+90)
 CEntityComponent(ECT_SOUND, SOUND_BULLET_STONE, 0, "EFNM" "data\\sounds\\Default.wav"),
#define SOUND_BULLET_SAND ((0x00000259<<8)+91)
 CEntityComponent(ECT_SOUND, SOUND_BULLET_SAND, 0, "EFNM" "data\\sounds\\Default.wav"),
#define SOUND_BULLET_WATER ((0x00000259<<8)+92)
 CEntityComponent(ECT_SOUND, SOUND_BULLET_WATER, 0, "EFNM" "data\\sounds\\Default.wav"),
#define SOUND_BULLET_FLESH ((0x00000259<<8)+93)
 CEntityComponent(ECT_SOUND, SOUND_BULLET_FLESH, 0, "EFNM" "data\\sounds\\Default.wav"),
#define TEXTURE_BULLET_SAND ((0x00000259<<8)+94)
 CEntityComponent(ECT_TEXTURE, TEXTURE_BULLET_SAND, 0, "EFNM" "Data\\Models\\Effects\\BulletOnTheWall\\BulletSand.tex"),
#define SOUND_BULLET_GRASS ((0x00000259<<8)+95)
 CEntityComponent(ECT_SOUND, SOUND_BULLET_GRASS, 0, "EFNM" "data\\sounds\\Default.wav"),
#define SOUND_BULLET_WOOD ((0x00000259<<8)+96)
 CEntityComponent(ECT_SOUND, SOUND_BULLET_WOOD, 0, "EFNM" "data\\sounds\\Default.wav"),
#define SOUND_BULLET_SNOW ((0x00000259<<8)+97)
 CEntityComponent(ECT_SOUND, SOUND_BULLET_SNOW, 0, "EFNM" "data\\sounds\\Default.wav"),
#define MODEL_BLOOD_EXPLODE ((0x00000259<<8)+21)
 CEntityComponent(ECT_MODEL, MODEL_BLOOD_EXPLODE, 0, "EFNM" "Data\\Models\\Effects\\BloodCloud\\BloodCloud.mdl"),
#define TEXTURE_BLOOD_EXPLODE ((0x00000259<<8)+22)
 CEntityComponent(ECT_TEXTURE, TEXTURE_BLOOD_EXPLODE, 0, "EFNM" "Data\\Models\\Effects\\BloodCloud\\BloodCloud.tex"),
#define MODEL_BLOOD_STAIN ((0x00000259<<8)+23)
 CEntityComponent(ECT_MODEL, MODEL_BLOOD_STAIN, 0, "EFNM" "Data\\Models\\Effects\\BloodOnTheWall01\\Blood.mdl"),
#define TEXTURE_BLOOD_STAIN1 ((0x00000259<<8)+24)
 CEntityComponent(ECT_TEXTURE, TEXTURE_BLOOD_STAIN1, 0, "EFNM" "Data\\Models\\Effects\\BloodOnTheWall01\\BloodStain01.tex"),
#define TEXTURE_BLOOD_STAIN2 ((0x00000259<<8)+25)
 CEntityComponent(ECT_TEXTURE, TEXTURE_BLOOD_STAIN2, 0, "EFNM" "Data\\Models\\Effects\\BloodOnTheWall01\\BloodStain02.tex"),
#define TEXTURE_BLOOD_STAIN3 ((0x00000259<<8)+26)
 CEntityComponent(ECT_TEXTURE, TEXTURE_BLOOD_STAIN3, 0, "EFNM" "Data\\Models\\Effects\\BloodOnTheWall01\\BloodStain03.tex"),
#define TEXTURE_BLOOD_STAIN4 ((0x00000259<<8)+27)
 CEntityComponent(ECT_TEXTURE, TEXTURE_BLOOD_STAIN4, 0, "EFNM" "Data\\Models\\Effects\\BloodOnTheWall01\\BloodStain04.tex"),
#define TEXTURE_BLOOD_SPILL1 ((0x00000259<<8)+28)
 CEntityComponent(ECT_TEXTURE, TEXTURE_BLOOD_SPILL1, 0, "EFNM" "Data\\Models\\Effects\\BloodOnTheWall01\\BloodSpill02.tex"),
#define TEXTURE_BLOOD_SPILL2 ((0x00000259<<8)+29)
 CEntityComponent(ECT_TEXTURE, TEXTURE_BLOOD_SPILL2, 0, "EFNM" "Data\\Models\\Effects\\BloodOnTheWall01\\BloodSpill05.tex"),
#define TEXTURE_BLOOD_SPILL3 ((0x00000259<<8)+30)
 CEntityComponent(ECT_TEXTURE, TEXTURE_BLOOD_SPILL3, 0, "EFNM" "Data\\Models\\Effects\\BloodOnTheWall01\\BloodSpill06.tex"),
#define TEXTURE_BLOOD_FLOWER1 ((0x00000259<<8)+31)
 CEntityComponent(ECT_TEXTURE, TEXTURE_BLOOD_FLOWER1, 0, "EFNM" "Data\\Models\\Effects\\Flowers\\Flowers1s.tex"),
#define TEXTURE_BLOOD_FLOWER2 ((0x00000259<<8)+32)
 CEntityComponent(ECT_TEXTURE, TEXTURE_BLOOD_FLOWER2, 0, "EFNM" "Data\\Models\\Effects\\Flowers\\Flowers2s.tex"),
#define TEXTURE_BLOOD_FLOWER3 ((0x00000259<<8)+33)
 CEntityComponent(ECT_TEXTURE, TEXTURE_BLOOD_FLOWER3, 0, "EFNM" "Data\\Models\\Effects\\Flowers\\Flowers3s.tex"),
#define MODEL_SHOCKWAVE ((0x00000259<<8)+40)
 CEntityComponent(ECT_MODEL, MODEL_SHOCKWAVE, 0, "EFNM" "Data\\Models\\Effects\\ShockWave01\\ShockWave.mdl"),
#define TEXTURE_SHOCKWAVE ((0x00000259<<8)+41)
 CEntityComponent(ECT_TEXTURE, TEXTURE_SHOCKWAVE, 0, "EFNM" "Data\\Models\\Effects\\ShockWave01\\Textures\\ShockWave.tex"),
#define MODEL_CANNONSHOCKWAVE ((0x00000259<<8)+42)
 CEntityComponent(ECT_MODEL, MODEL_CANNONSHOCKWAVE, 0, "EFNM" "Data\\Models\\Effects\\ShockWave01\\ShockWave.mdl"),
#define TEXTURE_CANNONSHOCKWAVE ((0x00000259<<8)+43)
 CEntityComponent(ECT_TEXTURE, TEXTURE_CANNONSHOCKWAVE, 0, "EFNM" "Data\\Models\\Effects\\ShockWave01\\Textures\\ShockWave.tex"),
#define MODEL_EXPLOSION_STAIN ((0x00000259<<8)+45)
 CEntityComponent(ECT_MODEL, MODEL_EXPLOSION_STAIN, 0, "EFNM" "Data\\Models\\Effects\\BurnedStainOnTheWall\\BurnedStainOnTheWall.mdl"),
#define TEXTURE_EXPLOSION_STAIN ((0x00000259<<8)+46)
 CEntityComponent(ECT_TEXTURE, TEXTURE_EXPLOSION_STAIN, 0, "EFNM" "Data\\Models\\Effects\\BurnedStainOnTheWall\\BurnedStainOnTheWall.tex"),
#define MODEL_CANNON_EXPLOSION_STAIN ((0x00000259<<8)+47)
 CEntityComponent(ECT_MODEL, MODEL_CANNON_EXPLOSION_STAIN, 0, "EFNM" "Data\\Models\\Effects\\BurnedStainOnTheWall\\BurnedStainOnTheWall.mdl"),
#define TEXTURE_CANNON_EXPLOSION_STAIN ((0x00000259<<8)+48)
 CEntityComponent(ECT_TEXTURE, TEXTURE_CANNON_EXPLOSION_STAIN, 0, "EFNM" "Data\\Models\\Effects\\BurnedStainOnTheWall\\BurnedStainOnTheWall.tex"),
#define MODEL_LASERWAVE ((0x00000259<<8)+50)
 CEntityComponent(ECT_MODEL, MODEL_LASERWAVE, 0, "EFNM" "Data\\Models\\Effects\\ShockWaveGreen\\ShockWaveGreen.mdl"),
#define TEXTURE_LASERWAVE ((0x00000259<<8)+51)
 CEntityComponent(ECT_TEXTURE, TEXTURE_LASERWAVE, 0, "EFNM" "Data\\Models\\Effects\\ShockWaveGreen\\ShockWaveGreen.tex"),
#define MODEL_TELEPORT_EFFECT ((0x00000259<<8)+61)
 CEntityComponent(ECT_MODEL, MODEL_TELEPORT_EFFECT, 0, "EFNM" "Data\\Models\\Effects\\Teleport01\\Teleport.mdl"),
#define TEXTURE_TELEPORT_EFFECT ((0x00000259<<8)+62)
 CEntityComponent(ECT_TEXTURE, TEXTURE_TELEPORT_EFFECT, 0, "EFNM" "Data\\Textures\\Effects\\Effect01\\Effect.tex"),
#define SOUND_TELEPORT ((0x00000259<<8)+63)
 CEntityComponent(ECT_SOUND, SOUND_TELEPORT, 0, "EFNM" "Data\\Sounds\\Misc\\Teleport.wav"),
#define TEXTURE_WATER_WAVE ((0x00000259<<8)+100)
 CEntityComponent(ECT_TEXTURE, TEXTURE_WATER_WAVE, 0, "EFNM" "Data\\Models\\Effects\\ShockWave01\\Textures\\WaterWave.tex"),
};
...
#line 1359 "C:/Users/djcyb/Desktop/BAckups/Reco_Csrc/EntitiesMP/BasicEffects.es"
...
#line 1459 "C:/Users/djcyb/Desktop/BAckups/Reco_Csrc/EntitiesMP/BasicEffects.es"
