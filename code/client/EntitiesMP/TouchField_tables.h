...
EP_ENUMBEG(TouchFieldType)
	...
	EP_ENUMVALUE(TOUCHFIELD_EVENT, "Send Event Message of Raid system"),
...
CEntityProperty CTouchField_properties[] = {
 ...
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x000000ce<<8)+200, offsetof(CTouchField, m_bRaidObject), "This entity is RaidObject", 0, 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_INDEX, NULL, (0x000000ce<<8)+201, offsetof(CTouchField, m_RaidEventType), "Raid Event Type", 0, 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x000000ce<<8)+202, offsetof(CTouchField, m_bActiveEffect), "Trigger Active Effect", 0, 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_STRING, NULL, (0x000000ce<<8)+203, offsetof(CTouchField, m_strEffectGroupName), "Trigger Effect Name(Event)", 0, 0x7F0000FFUL, 0),
 ...
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x000000ce<<8)+10, offsetof(CTouchField, m_bCollision), "Collision", 0, 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_ENTITYPTR, NULL, (0x000000ce<<8)+100, offsetof(CTouchField, m_penLastIn), "", 0, 0, 0),
 CEntityProperty(CEntityProperty::EPT_ENTITYPTR, NULL, (0x000000ce<<8)+110, offsetof(CTouchField, m_penOnly), "Target Only", 0, 0x7F0000FFUL, 0),
...
#line 153 "C:/Users/djcyb/Desktop/BAckups/Reco_Csrc/EntitiesMP/TouchField.es"
Main),DEBUGSTRING("CTouchField::Main")},
 {0x00ce0000, -1, CEntity::pEventHandler(&CTouchField::
#line 194 "C:/Users/djcyb/Desktop/BAckups/Reco_Csrc/EntitiesMP/TouchField.es"
...
#line 349 "C:/Users/djcyb/Desktop/BAckups/Reco_Csrc/EntitiesMP/TouchField.es"
...
#line 418 "C:/Users/djcyb/Desktop/BAckups/Reco_Csrc/EntitiesMP/TouchField.es"
