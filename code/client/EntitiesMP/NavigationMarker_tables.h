...
CDLLEntityEvent *CNavigationMarker_events[] = {NULL};
#define CNavigationMarker_eventsct 0
...
#define MODEL_MARKER ((0x000002c0<<8)+1)
 CEntityComponent(ECT_MODEL, MODEL_MARKER, 2, "EFNM" "Data\\Models\\Editor\\NavigationMarker.mdl"),
#define TEXTURE_MARKER ((0x000002c0<<8)+2)
 CEntityComponent(ECT_TEXTURE, TEXTURE_MARKER, 2, "EFNM" "Data\\Models\\Editor\\NavigationMarker.tex"),
};
