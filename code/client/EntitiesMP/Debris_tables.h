...
CEntityEvent *ESpawnDebris_New(void) { return new ESpawnDebris; };
CDLLEntityEvent DLLEvent_ESpawnDebris = {
	0x025a0000, &ESpawnDebris_New
};
CDLLEntityEvent *CDebris_events[] = {
	&DLLEvent_ESpawnDebris,
};
#define CDebris_eventsct ARRAYCOUNT(CDebris_events)
...
CEntityProperty CDebris_properties[] = {
 ...
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x0000025a<<8)+200, offsetof(CDebris, m_bDebrisFade), "", 0, 0, 0),
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x0000025a<<8)+201, offsetof(CDebris, m_bDebrisCollision), "", 0, 0, 0),
};
