...
CEntityEvent *ESpawnSpray_New(void) { return new ESpawnSpray; };
CDLLEntityEvent DLLEvent_ESpawnSpray = {
	0x025b0000, &ESpawnSpray_New
};
CDLLEntityEvent *CBloodSpray_events[] = {
	&DLLEvent_ESpawnSpray,
};
#define CBloodSpray_eventsct ARRAYCOUNT(CBloodSpray_events)
#define ENTITYCLASS CBloodSpray

CEntityProperty CBloodSpray_properties[] = {
 CEntityProperty(CEntityProperty::EPT_ENUM, &SprayParticlesType_enum, (0x0000025b<<8)+1, offsetof(CBloodSpray, m_sptType), "", 0, 0, EPROPF_NETSEND ),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x0000025b<<8)+2, offsetof(CBloodSpray, m_tmStarted), "", 0, 0, EPROPF_NETSEND ),
 CEntityProperty(CEntityProperty::EPT_FLOAT3D, NULL, (0x0000025b<<8)+3, offsetof(CBloodSpray, m_vDirection), "", 0, 0, EPROPF_NETSEND ),
 CEntityProperty(CEntityProperty::EPT_ENTITYPTR, NULL, (0x0000025b<<8)+5, offsetof(CBloodSpray, m_penOwner), "", 0, 0, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x0000025b<<8)+6, offsetof(CBloodSpray, m_fDamagePower), "", 0, 0, EPROPF_NETSEND ),
 ...
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x0000025b<<8)+11, offsetof(CBloodSpray, m_fLaunchPower), "", 0, 0, EPROPF_NETSEND ),
 CEntityProperty(CEntityProperty::EPT_COLOR, NULL, (0x0000025b<<8)+12, offsetof(CBloodSpray, m_colCentralColor), "", 0, 0, EPROPF_NETSEND ),
 CEntityProperty(CEntityProperty::EPT_FLOATAABBOX3D, NULL, (0x0000025b<<8)+13, offsetof(CBloodSpray, m_boxOriginalOwner), "", 0, 0, 0),
 CEntityProperty(CEntityProperty::EPT_COLOR, NULL, (0x0000025b<<8)+14, offsetof(CBloodSpray, m_colBurnColor), "", 0, 0, EPROPF_NETSEND ),
 CEntityProperty(CEntityProperty::EPT_INDEX, NULL, (0x0000025b<<8)+15, offsetof(CBloodSpray, m_iOwner), "", 0, 0, EPROPF_NETSEND ),
