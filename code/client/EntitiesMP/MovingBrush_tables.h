...
CEntityEvent *EHit_New(void) { return new EHit; };
CDLLEntityEvent DLLEvent_EHit = {
	0x00650000, &EHit_New
};
CEntityEvent *EBrushDestroyed_New(void) { return new EBrushDestroyed; };
CDLLEntityEvent DLLEvent_EBrushDestroyed = {
	0x00650001, &EBrushDestroyed_New
};
CEntityEvent *EStartSounds_New(void) { return new EStartSounds; };
CDLLEntityEvent DLLEvent_EStartSounds = {
	0x00650002, &EStartSounds_New
};
CEntityEvent *EStopSounds_New(void) { return new EStopSounds; };
CDLLEntityEvent DLLEvent_EStopSounds = {
	0x00650003, &EStopSounds_New
};
CEntityEvent *EBrushDeath_New(void) { return new EBrushDeath; };
CDLLEntityEvent DLLEvent_EBrushDeath = {
	0x00650004, &EBrushDeath_New
};
...
CDLLEntityEvent *CMovingBrush_events[] = {
	&DLLEvent_EBrushDeath,
	&DLLEvent_EStopSounds,
	&DLLEvent_EStartSounds,
	&DLLEvent_EBrushDestroyed,
	&DLLEvent_EHit,
};
#define CMovingBrush_eventsct ARRAYCOUNT(CMovingBrush_events)
...
CEntityProperty CMovingBrush_properties[] = {
 ...
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x00000065<<8)+99, offsetof(CMovingBrush, m_bStartAtFirstMarker), "Start At First Marker", 0, 0x7F0000FFUL, 0),
 ...
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x00000065<<8)+100, offsetof(CMovingBrush, m_bFade), "Fade Debris", 0, 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x00000065<<8)+101, offsetof(CMovingBrush, m_bCollision), "Collision Debris", 0, 0x7F0000FFUL, 0),
};
...
#define MODEL_STONE ((0x00000065<<8)+14)
 CEntityComponent(ECT_MODEL, MODEL_STONE, 0, "EFNM" "Data\\Models\\Effects\\Debris\\Stone\\Stone.mdl"),
#define TEXTURE_STONE ((0x00000065<<8)+15)
 CEntityComponent(ECT_TEXTURE, TEXTURE_STONE, 0, "EFNM" "Data\\Models\\Effects\\Debris\\Stone\\Stone.tex"),
...
Main),DEBUGSTRING("CMovingBrush::Main")},
 {0x00650005, -1, CEntity::pEventHandler(&CMovingBrush::H0x00650005_Main_01), DEBUGSTRING("CMovingBrush::H0x00650005_Main_01")},
 {0x00650006, -1, CEntity::pEventHandler(&CMovingBrush::H0x00650006_Main_02), DEBUGSTRING("CMovingBrush::H0x00650006_Main_02")},
 {0x00650007, -1, CEntity::pEventHandler(&CMovingBrush::H0x00650007_Main_03), DEBUGSTRING("CMovingBrush::H0x00650007_Main_03")},
 {0x00650008, -1, CEntity::pEventHandler(&CMovingBrush::H0x00650008_Main_04), DEBUGSTRING("CMovingBrush::H0x00650008_Main_04")},
...
MoveToMarker),DEBUGSTRING("CMovingBrush::MoveToMarker")},
 {0x0065000a, -1, CEntity::pEventHandler(&CMovingBrush::H0x0065000a_MoveToMarker_01), DEBUGSTRING("CMovingBrush::H0x0065000a_MoveToMarker_01")},
 {0x0065000b, -1, CEntity::pEventHandler(&CMovingBrush::H0x0065000b_MoveToMarker_02), DEBUGSTRING("CMovingBrush::H0x0065000b_MoveToMarker_02")},
...
BounceObstructed),DEBUGSTRING("CMovingBrush::BounceObstructed")},
 {0x0065000d, -1, CEntity::pEventHandler(&CMovingBrush::H0x0065000d_BounceObstructed_01), DEBUGSTRING("CMovingBrush::H0x0065000d_BounceObstructed_01")},
 {0x0065000e, -1, CEntity::pEventHandler(&CMovingBrush::H0x0065000e_BounceObstructed_02), DEBUGSTRING("CMovingBrush::H0x0065000e_BounceObstructed_02")},
...
MoveBrush),DEBUGSTRING("CMovingBrush::MoveBrush")},
 ...
 {0x00650019, -1, CEntity::pEventHandler(&CMovingBrush::H0x00650019_MoveBrush_10), DEBUGSTRING("CMovingBrush::H0x00650019_MoveBrush_10")},
 {0x0065001a, -1, CEntity::pEventHandler(&CMovingBrush::
