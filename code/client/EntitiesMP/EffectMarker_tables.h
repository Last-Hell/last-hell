...
CEntityEvent *ENetTrigger_New(void) { return new ENetTrigger; };
CDLLEntityEvent DLLEvent_ENetTrigger = {
	0x02630000, &ENetTrigger_New
};
CDLLEntityEvent *CEffectMarker_events[] = {
	&DLLEvent_ENetTrigger,
};
#define CEffectMarker_eventsct ARRAYCOUNT(CEffectMarker_events)
