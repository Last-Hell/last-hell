...
CEntityEvent *EActivateBlend_New(void) { return new EActivateBlend; };
CDLLEntityEvent DLLEvent_EActivateBlend = {
	0x02640000, &EActivateBlend_New
};
CEntityEvent *EDeactivateBlend_New(void) { return new EDeactivateBlend; };
CDLLEntityEvent DLLEvent_EDeactivateBlend = {
	0x02640001, &EDeactivateBlend_New
};
CDLLEntityEvent *CBlendController_events[] = {
	&DLLEvent_EDeactivateBlend,
	&DLLEvent_EActivateBlend,
};
#define CBlendController_eventsct ARRAYCOUNT(CBlendController_events)
...
#line 115 "C:/Users/djcyb/Desktop/BAckups/Reco_Csrc/EntitiesMP/BlendController.es"
