...
CEntityEvent *EArchitectureDeath_New(void) { return new EArchitectureDeath; };
CDLLEntityEvent DLLEvent_EArchitectureDeath = {
	0x006b0000, &EArchitectureDeath_New
};
CDLLEntityEvent *CDestroyableArchitecture_events[] = {
	&DLLEvent_EArchitectureDeath,
};
#define CDestroyableArchitecture_eventsct ARRAYCOUNT(CDestroyableArchitecture_events)
...
#define TEXTURE_OBELISK ((0x0000006b<<8)+10)
 CEntityComponent(ECT_TEXTURE, TEXTURE_OBELISK, 0, "EFNM" "Data\\Models\\CutSequences\\Obelisk\\Obelisk.tex"),
#define MODEL_OBELISK01 ((0x0000006b<<8)+11)
 CEntityComponent(ECT_MODEL, MODEL_OBELISK01, 0, "EFNM" "Data\\Models\\CutSequences\\Obelisk\\Part01.mdl"),
#define MODEL_OBELISK02 ((0x0000006b<<8)+12)
 CEntityComponent(ECT_MODEL, MODEL_OBELISK02, 0, "EFNM" "Data\\Models\\CutSequences\\Obelisk\\Part02.mdl"),
#define MODEL_OBELISK03 ((0x0000006b<<8)+13)
 CEntityComponent(ECT_MODEL, MODEL_OBELISK03, 0, "EFNM" "Data\\Models\\CutSequences\\Obelisk\\Part03.mdl"),
#define MODEL_OBELISK04 ((0x0000006b<<8)+14)
 CEntityComponent(ECT_MODEL, MODEL_OBELISK04, 0, "EFNM" "Data\\Models\\CutSequences\\Obelisk\\Part04.mdl"),
#define MODEL_OBELISK05 ((0x0000006b<<8)+15)
 CEntityComponent(ECT_MODEL, MODEL_OBELISK05, 0, "EFNM" "Data\\Models\\CutSequences\\Obelisk\\Part05.mdl"),
#define MODEL_OBELISK06 ((0x0000006b<<8)+16)
 CEntityComponent(ECT_MODEL, MODEL_OBELISK06, 0, "EFNM" "Data\\Models\\CutSequences\\Obelisk\\Part06.mdl"),
#define MODEL_OBELISK07 ((0x0000006b<<8)+17)
 CEntityComponent(ECT_MODEL, MODEL_OBELISK07, 0, "EFNM" "Data\\Models\\CutSequences\\Obelisk\\Part07.mdl"),
#define MODEL_OBELISK08 ((0x0000006b<<8)+18)
 CEntityComponent(ECT_MODEL, MODEL_OBELISK08, 0, "EFNM" "Data\\Models\\CutSequences\\Obelisk\\Part08.mdl"),
#define MODEL_OBELISK09 ((0x0000006b<<8)+19)
 CEntityComponent(ECT_MODEL, MODEL_OBELISK09, 0, "EFNM" "Data\\Models\\CutSequences\\Obelisk\\Part09.mdl"),
#define TEXTURE_PYLON ((0x0000006b<<8)+20)
 CEntityComponent(ECT_TEXTURE, TEXTURE_PYLON, 0, "EFNM" "Data\\Models\\CutSequences\\Pylon\\Pylon.tex"),
#define MODEL_PYLON01 ((0x0000006b<<8)+21)
 CEntityComponent(ECT_MODEL, MODEL_PYLON01, 0, "EFNM" "Data\\Models\\CutSequences\\Pylon\\Part01.mdl"),
#define MODEL_PYLON02 ((0x0000006b<<8)+22)
 CEntityComponent(ECT_MODEL, MODEL_PYLON02, 0, "EFNM" "Data\\Models\\CutSequences\\Pylon\\Part02.mdl"),
#define MODEL_PYLON03 ((0x0000006b<<8)+23)
 CEntityComponent(ECT_MODEL, MODEL_PYLON03, 0, "EFNM" "Data\\Models\\CutSequences\\Pylon\\Part03.mdl"),
#define MODEL_PYLON04 ((0x0000006b<<8)+24)
 CEntityComponent(ECT_MODEL, MODEL_PYLON04, 0, "EFNM" "Data\\Models\\CutSequences\\Pylon\\Part04.mdl"),
#define MODEL_PYLON05 ((0x0000006b<<8)+25)
 CEntityComponent(ECT_MODEL, MODEL_PYLON05, 0, "EFNM" "Data\\Models\\CutSequences\\Pylon\\Part05.mdl"),
#define MODEL_PYLON06 ((0x0000006b<<8)+26)
 CEntityComponent(ECT_MODEL, MODEL_PYLON06, 0, "EFNM" "Data\\Models\\CutSequences\\Pylon\\Part06.mdl"),
#define MODEL_PYLON07 ((0x0000006b<<8)+27)
 CEntityComponent(ECT_MODEL, MODEL_PYLON07, 0, "EFNM" "Data\\Models\\CutSequences\\Pylon\\Part07.mdl"),
#define MODEL_PYLON08 ((0x0000006b<<8)+28)
 CEntityComponent(ECT_MODEL, MODEL_PYLON08, 0, "EFNM" "Data\\Models\\CutSequences\\Pylon\\Part08.mdl"),
#define MODEL_PYLON09 ((0x0000006b<<8)+29)
 CEntityComponent(ECT_MODEL, MODEL_PYLON09, 0, "EFNM" "Data\\Models\\CutSequences\\Pylon\\Part09.mdl"),
...
#define CLASS_EFFECTOR ((0x0000006b<<8)+31)
 CEntityComponent(ECT_CLASS, CLASS_EFFECTOR, 0, "EFNM" "Classes\\Effector.ecl"),
...
Main),DEBUGSTRING("CDestroyableArchitecture::Main")},
 {0x006b0001, -1, CEntity::pEventHandler(&CDestroyableArchitecture::H0x006b0001_Main_01), DEBUGSTRING("CDestroyableArchitecture::H0x006b0001_Main_01")},
 {0x006b0002, -1, CEntity::pEventHandler(&CDestroyableArchitecture::H0x006b0002_Main_02), DEBUGSTRING("CDestroyableArchitecture::H0x006b0002_Main_02")},
};
