...
CEntityEvent *EStormEnvironmentStart_New(void) { return new EStormEnvironmentStart; };
CDLLEntityEvent DLLEvent_EStormEnvironmentStart = {
	0x025e0000, &EStormEnvironmentStart_New
};
CEntityEvent *EStormStart_New(void) { return new EStormStart; };
CDLLEntityEvent DLLEvent_EStormStart = {
	0x025e0001, &EStormStart_New
};
CEntityEvent *EStormStop_New(void) { return new EStormStop; };
CDLLEntityEvent DLLEvent_EStormStop = {
	0x025e0002, &EStormStop_New
};
CDLLEntityEvent *CStormController_events[] = {
	&DLLEvent_EStormStop,
	&DLLEvent_EStormStart,
	&DLLEvent_EStormEnvironmentStart,
};
#define CStormController_eventsct ARRAYCOUNT(CStormController_events)
...
CEntityProperty CStormController_properties[] = {
 ...
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x0000025e<<8)+4, offsetof(CStormController, m_bStormOn), "", 0, 0, EPROPF_NETSEND ),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x0000025e<<8)+5, offsetof(CStormController, m_fNextLightningStrike), "", 0, 0, EPROPF_NETSEND ),
...
#define MODEL_STORM_CONTROLLER ((0x0000025e<<8)+1)
 CEntityComponent(ECT_MODEL, MODEL_STORM_CONTROLLER, 2, "EFNM" "Data\\Models\\Editor\\StormController.mdl"),
#define TEXTURE_STORM_CONTROLLER ((0x0000025e<<8)+2)
 CEntityComponent(ECT_TEXTURE, TEXTURE_STORM_CONTROLLER, 2, "EFNM" "Data\\Models\\Editor\\StormController.tex"),
};
...
#line 144 "C:/Users/djcyb/Desktop/BAckups/Reco_Csrc/EntitiesMP/StormController.es"
Main),DEBUGSTRING("CStormController::Main")},
 {0x025e0003, -1, CEntity::pEventHandler(&CStormController::H0x025e0003_Main_01), DEBUGSTRING("CStormController::H0x025e0003_Main_01")},
 {0x025e0004, -1, CEntity::pEventHandler(&CStormController::H0x025e0004_Main_02), DEBUGSTRING("CStormController::H0x025e0004_Main_02")},
 {0x025e0005, -1, CEntity::pEventHandler(&CStormController::H0x025e0005_Main_03), DEBUGSTRING("CStormController::H0x025e0005_Main_03")},
 {0x025e0006, -1, CEntity::pEventHandler(&CStormController::H0x025e0006_Main_04), DEBUGSTRING("CStormController::H0x025e0006_Main_04")},
 {0x025e0007, -1, CEntity::pEventHandler(&CStormController::H0x025e0007_Main_05), DEBUGSTRING("CStormController::H0x025e0007_Main_05")},
 {0x025e0008, -1, CEntity::pEventHandler(&CStormController::H0x025e0008_Main_06), DEBUGSTRING("CStormController::H0x025e0008_Main_06")},
 {0x025e0009, -1, CEntity::pEventHandler(&CStormController::
#line 266 "C:/Users/djcyb/Desktop/BAckups/Reco_Csrc/EntitiesMP/StormController.es"
Storm),DEBUGSTRING("CStormController::Storm")},
 {0x025e000a, -1, CEntity::pEventHandler(&CStormController::H0x025e000a_Storm_01), DEBUGSTRING("CStormController::H0x025e000a_Storm_01")},
 {0x025e000b, -1, CEntity::pEventHandler(&CStormController::H0x025e000b_Storm_02), DEBUGSTRING("CStormController::H0x025e000b_Storm_02")},
 {0x025e000c, -1, CEntity::pEventHandler(&CStormController::
#line 274 "C:/Users/djcyb/Desktop/BAckups/Reco_Csrc/EntitiesMP/StormController.es"
StormInternal),DEBUGSTRING("CStormController::StormInternal")},
 {0x025e000d, -1, CEntity::pEventHandler(&CStormController::H0x025e000d_StormInternal_01), DEBUGSTRING("CStormController::H0x025e000d_StormInternal_01")},
 {0x025e000e, -1, CEntity::pEventHandler(&CStormController::H0x025e000e_StormInternal_02), DEBUGSTRING("CStormController::H0x025e000e_StormInternal_02")},
 {0x025e000f, -1, CEntity::pEventHandler(&CStormController::H0x025e000f_StormInternal_03), DEBUGSTRING("CStormController::H0x025e000f_StormInternal_03")},
 {0x025e0010, -1, CEntity::pEventHandler(&CStormController::H0x025e0010_StormInternal_04), DEBUGSTRING("CStormController::H0x025e0010_StormInternal_04")},
 {0x025e0011, -1, CEntity::pEventHandler(&CStormController::H0x025e0011_StormInternal_05), DEBUGSTRING("CStormController::H0x025e0011_StormInternal_05")},
 {0x025e0012, -1, CEntity::pEventHandler(&CStormController::H0x025e0012_StormInternal_06), DEBUGSTRING("CStormController::H0x025e0012_StormInternal_06")},
 {0x025e0013, -1, CEntity::pEventHandler(&CStormController::H0x025e0013_StormInternal_07), DEBUGSTRING("CStormController::H0x025e0013_StormInternal_07")},
 {0x025e0014, -1, CEntity::pEventHandler(&CStormController::H0x025e0014_StormInternal_08), DEBUGSTRING("CStormController::H0x025e0014_StormInternal_08")},
};
