...
CEntityEvent *ERangeModelDestruction_New(void) { return new ERangeModelDestruction; };
CDLLEntityEvent DLLEvent_ERangeModelDestruction = {
	0x00d90000, &ERangeModelDestruction_New
};
CEntityEvent *EModelDeath_New(void) { return new EModelDeath; };
CDLLEntityEvent DLLEvent_EModelDeath = {
	0x00d90001, &EModelDeath_New
};
...
CDLLEntityEvent *CModelDestruction_events[] = {
	&DLLEvent_EModelDeath,
	&DLLEvent_ERangeModelDestruction,
};
#define CModelDestruction_eventsct ARRAYCOUNT(CModelDestruction_events)
...
CEntityProperty CModelDestruction_properties[] = {
 ...
 CEntityProperty(CEntityProperty::EPT_STRING, NULL, (0x000000d9<<8)+60, offsetof(CModelDestruction, m_strStartAnim), "Start anim (for SKA)", 0, 0x7F0000FFUL, 0),
...
#define MODEL_MODELDESTRUCTION ((0x000000d9<<8)+1)
 CEntityComponent(ECT_MODEL, MODEL_MODELDESTRUCTION, 2, "EFNM" "Data\\Models\\Editor\\ModelDestruction.mdl"),
#define TEXTURE_MODELDESTRUCTION ((0x000000d9<<8)+2)
 CEntityComponent(ECT_TEXTURE, TEXTURE_MODELDESTRUCTION, 2, "EFNM" "Data\\Models\\Editor\\ModelDestruction.tex"),
#define CLASS_BASIC_EFFECT ((0x000000d9<<8)+3)
 CEntityComponent(ECT_CLASS, CLASS_BASIC_EFFECT, 0, "EFNM" "Classes\\BasicEffect.ecl"),
#define CLASS_SOUND_HOLDER ((0x000000d9<<8)+4)
 CEntityComponent(ECT_CLASS, CLASS_SOUND_HOLDER, 0, "EFNM" "Classes\\SoundHolder.ecl"),
#define MODEL_WOOD ((0x000000d9<<8)+10)
 CEntityComponent(ECT_MODEL, MODEL_WOOD, 0, "EFNM" "Data\\Models\\Effects\\Debris\\Wood01\\Wood.mdl"),
#define TEXTURE_WOOD ((0x000000d9<<8)+11)
 CEntityComponent(ECT_TEXTURE, TEXTURE_WOOD, 0, "EFNM" "Data\\Models\\Effects\\Debris\\Wood01\\Wood.tex"),
#define MODEL_BRANCH ((0x000000d9<<8)+12)
 CEntityComponent(ECT_MODEL, MODEL_BRANCH, 0, "EFNM" "Data\\ModelsMP\\Effects\\Debris\\Tree\\Tree.mdl"),
#define TEXTURE_BRANCH ((0x000000d9<<8)+13)
 CEntityComponent(ECT_TEXTURE, TEXTURE_BRANCH, 0, "EFNM" "Data\\ModelsMP\\Plants\\Tree01\\Tree01.tex"),
...
#define SOUND_DESTRUCTION_STONE ((0x000000d9<<8)+50)
 CEntityComponent(ECT_SOUND, SOUND_DESTRUCTION_STONE, 0, "EFNM" "SoundsMP\\Ambience\\StoneBreak.wav"),
#define SOUND_DESTRUCTION_WOOD ((0x000000d9<<8)+51)
 CEntityComponent(ECT_SOUND, SOUND_DESTRUCTION_WOOD, 0, "EFNM" "SoundsMP\\Ambience\\Crack.wav"),
#define SOUND_DESTRUCTION_PALM ((0x000000d9<<8)+52)
 CEntityComponent(ECT_SOUND, SOUND_DESTRUCTION_PALM, 0, "EFNM" "SoundsMP\\Ambience\\BranchesFall.wav"),
};
...
#line 428 "C:/Users/djcyb/Desktop/BAckups/Reco_Csrc/EntitiesMP/ModelDestruction.es"
