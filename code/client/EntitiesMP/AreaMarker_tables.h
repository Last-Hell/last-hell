...
CDLLEntityEvent *CAreaMarker_events[] = {NULL};
#define CAreaMarker_eventsct 0
#define ENTITYCLASS CAreaMarker

CEntityProperty CAreaMarker_properties[] = {
 CEntityProperty(CEntityProperty::EPT_STRING, NULL, (0x000000f8<<8)+1, offsetof(CAreaMarker, m_strName), "Name", 'N', 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_STRING, NULL, (0x000000f8<<8)+2, offsetof(CAreaMarker, m_strDescription), "", 0, 0, 0),
 CEntityProperty(CEntityProperty::EPT_FLOATAABBOX3D, NULL, (0x000000f8<<8)+3, offsetof(CAreaMarker, m_boxArea), "Area box", 'B', 0x7F0000FFUL, 0),
};
#define CAreaMarker_propertiesct ARRAYCOUNT(CAreaMarker_properties)

CEntityComponent CAreaMarker_components[] = {
#define MODEL_AREAMARKER ((0x000000f8<<8)+1)
 CEntityComponent(ECT_MODEL, MODEL_AREAMARKER, 2, "EFNM" "Data\\Models\\Editor\\Axis.mdl"),
#define TEXTURE_AREAMARKER ((0x000000f8<<8)+2)
...
#line 29 "C:/Users/djcyb/Desktop/BAckups/Reco_Csrc/EntitiesMP/AreaMarker.es"
...
ENTITY_CLASSDEFINITION(CAreaMarker, CEntity, "AreaMarker", "Thumbnails\\AreaMarker.tbn", 0x000000f8);
