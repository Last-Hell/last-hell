...
CDLLEntityEvent *CWatchPlayers_events[] = {NULL};
#define CWatchPlayers_eventsct 0
...
#define MODEL_WATCHPLAYERS ((0x000002be<<8)+1)
 CEntityComponent(ECT_MODEL, MODEL_WATCHPLAYERS, 2, "EFNM" "Data\\Models\\Editor\\WatchPlayers.mdl"),
#define TEXTURE_WATCHPLAYERS ((0x000002be<<8)+2)
 CEntityComponent(ECT_TEXTURE, TEXTURE_WATCHPLAYERS, 2, "EFNM" "Data\\Models\\Editor\\WatchPlayers.tex"),
};
