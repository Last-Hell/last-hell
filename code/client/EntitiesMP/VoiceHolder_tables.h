...
CDLLEntityEvent *CVoiceHolder_events[] = {NULL};
#define CVoiceHolder_eventsct 0
...
#define MODEL_MARKER ((0x000000e7<<8)+1)
 CEntityComponent(ECT_MODEL, MODEL_MARKER, 2, "EFNM" "Data\\Models\\Editor\\VoiceHolder.mdl"),
#define TEXTURE_MARKER ((0x000000e7<<8)+2)
 CEntityComponent(ECT_TEXTURE, TEXTURE_MARKER, 2, "EFNM" "Data\\Models\\Editor\\VoiceHolder.tex"),
};
